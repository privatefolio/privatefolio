...
export const extensions: Extension[] = [
  ...
  },
  {
    ...
    sources: [
      {
        tags: ["root"],
        url: "https://github.com/privatefolio/privatefolio/tree/main/packages/backend/src/extensions/file-imports/coinstats",
      },
    ],
    updatedAt: new Date("2025-07-28").getTime(),
  },
