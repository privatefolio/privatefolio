...
it("extractColumnsFromRow & createCsvString should work", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    [
      "{"assetIds":["chain.ethereum:0x0000000000000000000000000000000000000000:ETH"],"integration":"etherscan","logs":16,"operations":["Deposit","Withdraw","Fee"],"platform":"ethereum","rows":9,"transactions":9,"wallets":["0xf98c96b5d10faafc2324847c82305bd5fd7e5ad3"]}",
    ]
  `)
