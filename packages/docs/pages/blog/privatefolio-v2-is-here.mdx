...
* Desktop apps – they are [available to download](https://privatefolio.xyz/apps) for Windows, Linux, and Mac. You can install it and let it run in the background – no need to keep a browser tab open anymore.  
...
Try it now at [privatefolio.app](https://privatefolio.app) or [privatefolio.xyz/apps](https://privatefolio.xyz/apps).
