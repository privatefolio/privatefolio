...
This package contains common typescript libraries to build Privatefolio extensions or projects.
...
For documentation and guides, visit [docs.privatefolio.app](https://docs.privatefolio.app).
...
Check out our [developer quickstart on GitHub](https://github.com/privatefolio/privatefolio?tab=readme-ov-file#for-developers) and make sure to join our [Discord server](https://discord.gg/YHHu9nK8VD).
